...
<div class="i_bg">
        ...
        <div class="l_list">
            ...
            <div class="list_c">
                ...
                <ul class="cate_list">
                 ...
                 <c:forEach items="${pageutils.list}" var="list" varStatus="i">
                 <li>
                    	<div class="img"><a href="${pageContext.request.contextPath}/servlet/Product?id=${list.id}"><img src="${pageContext.request.contextPath}${filepath}${list.fileName}" width="210" height="185" /></a></div>
                        <div class="price">
                        ...
                        <div class="carbg">
                            ...
                            <a class="j_car"   onClick="add('${list.id}',1)">加入购物车</a>
                        </div>
                    </li>
				...
				<a href="${pageContext.request.contextPath}/servlet/QueryproductList?productid=${pcid}&&currentPage=${pageutils.currentPageNo-1}" class="p_pre">上一页</a>
				</c:if>
				<c:forEach var="i" begin="1" end="${pageutils.totalPageCount}">
				
				 <c:if test="${pageutils.currentPageNo!=i}">
				 <a href="${pageContext.request.contextPath}/servlet/QueryproductList?productid=${pcid}&&currentPage=${i}" class="cur">
				${i}</a>
				</c:if>
				...
				<c:if test="${pageutils.currentPageNo<pageutils.totalPageCount}">
				<a href="${pageContext.request.contextPath}/servlet/QueryproductList?productid=${pcid}&&currentPage=${pageutils.currentPageNo+1}" class="p_pre">下一页</a>
				</c:if>
			...
			<ul class="page-num-ul clearfix">
				...
				<a href="/news/servlet/NewsServlet?pageIndex=1">首页</a>
				<a href="/news/servlet/NewsServlet?pageIndex=${pageIndex-1}">上一页</a>
				
				</c:if>
				
				<c:if test="${pageIndex<totalPage}">
				<a href="/news/servlet/NewsServlet?pageIndex=${pageIndex+1}">下一页</a>
				<a href="/news/servlet/NewsServlet?pageIndex=${totalPage}">最后一页</a>
				</c:if>&nbsp;&nbsp;
			</ul>
 ...
 <div id="fade1" class="black_overlay"></div>
    <div id="MyDiv1" class="white_content">             
        <div class="white_d">
            <div class="notice_t">
                <span class="fr" style="margin-top:10px; cursor:pointer;" onclick="CloseDiv_1('MyDiv1','fade1')"><img src="${pageContext.request.contextPath }/page/images/close.gif" /></span>
            </div>
            <div class="notice_c">
                <table border="0" align="center" style="margin-top:;" cellspacing="0" cellpadding="0">
                  <tr valign="top">
                    <td width="40"><img src="${pageContext.request.contextPath }/page/images/suc.png" /></td>
                    <td>
...
var path="${pageContext.request.contextPath}";
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath }/page/js/Car.js"></script>
</body>
