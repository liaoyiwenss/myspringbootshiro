            ...
            <table border="0" style="width:370px; font-size:14px; margin-top:30px;" cellspacing="0" cellpadding="0">
              <tr height="50" valign="top">
                ...
                <td>
                    ...
                    <span class="fr">还没有商城账号，<a href="${pageContext.request.contextPath}/page/Regist.jsp" style="color:#ff4e00;">立即注册</a></span>
                </td>
              </tr>
              <tr height="70">
                <td>用户名</td>
...
<script>
    ...
    $(".log_btn").click(function () {
        ...
        }else if (u2.validity.valueMissing == true) {
            u2.setCustomValidity("密码不能为空");
        }
    });
...
/*   $.ajax({
						"url" : "${pageContext.request.contextPath}/servlet/Login",
						"type" : "post",
						"data" : {"username":u,"password":u2},
						"dataType" : "Json",
